...
const About = () => {
  return (
    <div className='h-screen bg-white flex flex-col pt-4 md:pt-10 lg:h-[1200px]'>
        <picture className='flex justify-center p-2'>
            <img src="./img/img001.jpg" alt="" width={300} className='rounded-2xl md:w-[500px] lg:w-[700px]'/>
        </picture>
        <div className='flex flex-col items-center text-center px-6'>
            <p className='text-2xl font-semibold pt-1 md:text-4xl lg:text-5xl md:p-10'>À propos de moi</p>
            <p className='text-xl font-semibold p-2 text-blue-700 lg:text-3xl lg:p-10'>Un développeur front-end autodidacte qui cherche à développer davantage ses compétences</p>
            <p className='text-sm px-3 leading-6 md:text-xl md:leading-10 lg:text-2xl lg:leading-[60px] lg:px-20'>
